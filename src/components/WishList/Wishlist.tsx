...
export default function Wishlist() {
  ...
  const [content, setContent] = useState("My List");
  ...
  return (
    <>
      ...
      <div className="wishlist" style={{ zIndex: wishlist ? 1020 : 800 }}>
        <div className="wishlist__header">
          <button onClick={handleWishlist}>
            Wishlist {wishlist ? exitIcon : arrowIcon}
          </button>
        </div>
        {wishlist ? (
          <div className="wishlist__body">
            ...
            <div className="wishlist__buttons">
              <button
                onClick={() => setContent("My List")}
                className="wishlist__button"
              >
                My List
              </button>
              <button
                onClick={() => setContent("Price Alert")}
                className="wishlist__button"
              >
                Price Alert
              </button>
              <button
                onClick={() => setContent("Recently visited")}
                className="wishlist__button"
              >
                Recently visited
              </button>
